...
public class AnimalBusiness {
    ...
    private AnimalBusiness(CareGiverController user) throws BDConnexionError,ErrorNull {
        this.user=user;
    ...
    public static AnimalBusiness obtenirAnimalBusiness(CareGiverController user)throws  BDConnexionError,ErrorNull
    {
        if(instance==null) instance=new AnimalBusiness(user);
        return instance;
    }
