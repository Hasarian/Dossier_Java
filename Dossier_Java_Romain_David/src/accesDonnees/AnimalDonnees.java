...
public class AnimalDonnees implements DAOAnimal {
    private Connection connection;
    public AnimalDonnees() throws DonneePermanenteErreur{
        connection = SingletonDB.getInstance();
    }

    @Override
    public Animal read(Integer id) throws Erreur {
        //business= AnimalBusiness.obtenirAnimalBusiness(ListeAnimalBusiness.obtenirListAnimalBusiness(new ControleSoignant()));
    ...
    public Animal resultatVersAnimal(ResultSet data)throws Erreur {
        try {
            ...
            /*(Integer id, String remarque, Integer numCell, String nomAnimal, Race race, GregorianCalendar dateArrivee,
                ...
                return new Animal(id, remarque, numCell,  race,nom, dateArrive, dateDeces, estDangereux, etatAnimal, remarqueSoin, etatSoins, (email==null)?null:new SoignantDonnees().read(email));
