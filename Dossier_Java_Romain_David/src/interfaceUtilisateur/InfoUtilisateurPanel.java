...
public class InfoUtilisateurPanel extends FormulaireInscriptionSoignantPanel
{
    ...
    public InfoUtilisateurPanel(Soignant soignant,MainFrame frame) throws Erreur
    {
        ...
        userControl=new ControleSoignant();
        setInfos(soignant.getPrenom(),soignant.getNomDeFamille(),soignant.getMail(),soignant.getRue(),soignant.getNumMaison(),
                soignant.getNumTel(),soignant.getRemarque(),soignant.getEstBenevole(),soignant.getLocalite(),soignant.getDateEmbauche());
        getConfirmButton().removeActionListener(getConfirmListener());
    ...
    public class MajListener implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                if(getNumTel()!=null) {Matcher NANTel = notNumber.matcher(getNumTel().toString());
