...
{
    private ListeDesTachesReserveesPanel thisPanel;
    private MainFrame frame;
    public ListeDesTachesReserveesPanel(EcranPrincipalPanel parentPanel, ControleSoignant user, MainFrame frame) throws Erreur {
